/* ********************************************************************** */
/**
 * @brief   ESM: state 3 event handler implementation (sample && test application).
 * @author  eel3
 * @date    2017-10-19
 */
/* ********************************************************************** */
...
static char handler_name_prefix[] = "state_3";
...
{
    event_handler_on_event(user_data, id, &state_1_event_handler);
}
...
const ESM_EVENT_HANDLER state_3_event_handler = {
