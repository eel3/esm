/* ********************************************************************** */
/**
 * @brief   ESM: state 1 event handler implementation (sample && test application).
 * @author  eel3
 * @date    2017-10-19
 */
/* ********************************************************************** */
...
static char handler_name_prefix[] = "state_1";
...
{
    event_handler_on_event(user_data, id, &state_2_event_handler);
}
...
const ESM_EVENT_HANDLER state_1_event_handler = {
